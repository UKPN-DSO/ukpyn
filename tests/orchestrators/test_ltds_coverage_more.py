...
@pytest.mark.parametrize(
    ("method_name", "kwargs", "expected_dataset", "expected_snippet", "check_type"),
    [
        (
            "get_table_2a_async",
            {"licence_area": "EPN", "substation": "ASHFORD"},
            "table_2a",
            "lv_substation='ASHFORD'",
            "where",
        ),
        (
            "get_table_2b_async",
...
async def test_ltds_async_helpers_build_where(
    ...
    """LTDS async helper methods build dataset key and where/refine clauses correctly."""
    ...
    if check_type == "where":
        ...
        assert expected_snippet in str(captured.get("refine"))
